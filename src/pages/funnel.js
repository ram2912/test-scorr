...
<h1 style={{ fontSize: '25px', fontFamily: 'IndustrialSans, sans-serif', marginTop: '5rem' }}>
      ...
      <h2 style={{ fontSize: '15px', fontFamily: 'inter, sans-serif',fontWeight:'300', marginTop: '1rem' }}>
        Lead Pipeline: <span style={{ color: 'white',letterSpacing: '0.5px'  }}>{leadPipeline}</span>
      </h2>
      <h2 style={{ fontSize: '15px', fontFamily: 'inter, sans-serif',fontWeight:'300', marginTop: '0.5rem' }}>
        BDR Pipeline: <span style={{ color: 'white',letterSpacing: '0.5px'  }}>{bdrPipeline}</span>
      </h2>
      <h2 style={{ fontSize: '15px', fontFamily: 'inter, sans-serif', fontWeight:'300', marginTop: '0.5rem', marginBottom:'0.5rem' }}>
